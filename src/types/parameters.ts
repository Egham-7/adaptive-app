 ...
 */
export function isValidSupportedParameter(param: string): param is SupportedParameter {
 ...
 */
export function isValidDefaultParameter(param: string): param is DefaultParameter {
