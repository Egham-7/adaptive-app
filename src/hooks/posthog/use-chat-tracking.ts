...
export function useChatTracking() {
	...
	const handleMessageRegenerated = useCallback(
		(conversationId: string, messageId: string) => {
			trackChatMessageRegenerated({
				conversationId,
				messageId,
	...
	const handleConversationRenamed = useCallback((conversationId: string) => {
	...
	const handleConversationUnpinned = useCallback((conversationId: string) => {
