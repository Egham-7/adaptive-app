		...
		if (highlighted) {
			return (
				<div
					...
					// biome-ignore lint/security/noDangerouslySetInnerHtml: Shiki generates HTML that needs to be rendered directly. Input is controlled and sanitized.
	...
	return (
		<div className="mx-auto w-full max-w-5xl">
			<div className="group relative w-full overflow-hidden rounded-md border border-border">
				...
				<div className="-translate-x-1/2 -translate-y-1/2 absolute top-1/2 left-1/2 hidden h-8 w-8 items-center justify-center rounded-md border border-primary/20 bg-accent text-foreground text-xs md:flex">
					VS
				</div>
			</div>
		</div>
