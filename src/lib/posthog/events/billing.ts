 ...
 */
export function trackBillingToggleSwitched(props: BillingToggleSwitchedProps): void {
 ...
 */
export function trackCheckoutSessionInitiated(props: CheckoutSessionInitiatedProps): void {
 ...
 */
export function trackSubscriptionCreated(props: SubscriptionCreatedProps): void {
 ...
 */
export function trackSubscriptionUpgraded(props: SubscriptionChangedProps): void {
 ...
 */
export function trackSubscriptionDowngraded(props: SubscriptionChangedProps): void {
 ...
 */
export function trackSubscriptionCanceled(props?: Omit<SubscriptionChangedProps, 'changeType'>): void {
 ...
 */
export function trackSubscriptionRenewed(props?: Omit<SubscriptionChangedProps, 'changeType'>): void {
 ...
 */
export function trackPromotionalCreditApplied(props: PromotionalCreditAppliedProps): void {
